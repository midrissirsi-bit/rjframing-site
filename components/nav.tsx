...
export function Nav() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-5 md:px-16 text-bone" style={{ mixBlendMode: "difference" }}>
      <a href="#top" className="flex items-center gap-3">
        <img src="/images/logo.png" alt="RJ Framing" className="h-9 w-auto" />
      </a>
